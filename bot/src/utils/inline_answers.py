...
class Icons:
    ERROR: str = (
        "https://img.icons8.com/?size=100&id=DXECg4JU1n2x&format=png&color=000000"
    )
    AUDIO: str = (
        "https://img.icons8.com/?size=100&id=VmIchBapvMDA&format=png&color=000000"
    )
    TEXT: str = (
        "https://img.icons8.com/?size=100&id=7Toxu00bPFMa&format=png&color=000000"
    )
    LINK: str = (
        "https://img.icons8.com/?size=100&id=QYd5yJnmjVdK&format=png&color=000000"
    )
...
def add_audio_track(track: TrackData):
    return InlineQueryResultAudio(
        ...
        caption=f"[Я.Музыка]({track.ya_link}) • [songlink]({track.songlink})"
        if track.songlink
        else f"[Я.Музыка]({track.ya_link})",
...
def add_text_track(track: TrackData):
    ...
    return InlineQueryResultArticle(
        ...
        input_message_content=InputTextMessageContent(
            message_text=text, parse_mode=ParseMode.MARKDOWN
        ),
    )
